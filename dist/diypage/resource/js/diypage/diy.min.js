define(['jquery.ui'], function(ui) {
	...
	modal.initNavs = function() {
		...
		if(!plugin_ds){
			navpage.splice(contains(navpage, 'mlist'), 1)
		}
		console.log(navpage);
		...
		$.each(customPageList, function(index, item) {
			...
			$.each(modal.navs, function(key, value) {
				...
				} else if(index === 3 && (id == 'kpgg' || id == 'tcgg' || id == 'wyrq' || id == 'footmenu' || id == 'feedback' || id == 'test')) {
